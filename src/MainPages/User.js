...
import { Create, List, Datagrid, Edit, EditButton, SimpleForm, BooleanField, BooleanInput, ImageField, ImageInput,
  EmailField, TextField, TextInput, PasswordInput, NumberField, NumberInput, email, SelectInput, useCreate, useRecordContext } from 'react-admin';
